...
Oringially cloned from [documentation website](https://awslabs.github.io/data-on-eks/docs/streaming-platforms-eks/kafka) to deploy this pattern and run sample tests.

## Updated the YML config to reduce the size of EKS nodes
